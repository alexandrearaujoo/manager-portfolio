  ...
  return (
    <>
      <button
        ...
        className="group flex items-center justify-start w-12 h-12 border-none rounded-md relative mx-5 overflow-hidden transition-all duration-200 bg-button-gradient hover:w-36 hover:transition-all hover:duration-200"
      >
